...
const HorizontalDatePicker: React.FC<HorizontalDatePickerProps> = ({ selectedDate }) => {
        ...
        <View style={styles.container}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    ...
                    const isSelected = internalSelectedDate && item.toDateString() === internalSelectedDate.toDateString();

                    return (
                        <Link asChild className="self-center" href={`/(shifts)/(shift)/${item}`}>
